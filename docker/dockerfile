...
COPY ./../security /opt/spring_boot_todo_api/security
...
COPY --from=build /opt/spring_boot_todo_api/security ./security
EXPOSE 8080
CMD ["java", "-Xms128m", "-Xmx350m", "-jar", "/opt/spring_boot_todo_api/api.jar"]
